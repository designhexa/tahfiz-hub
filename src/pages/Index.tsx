    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/10 via-background to-secondary/10">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center space-y-6 max-w-4xl mx-auto">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-primary to-lime shadow-lg animate-fade-in">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-20 max-w-6xl mx-auto">
          {[
            ...
            >
              <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-primary to-lime flex items-center justify-center mb-4">
